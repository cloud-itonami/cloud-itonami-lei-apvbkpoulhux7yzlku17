(ns tosmonitor.store
  ...
  This repo archives exactly ONE company (Antero Resources Corporation, LEI
  APVBKPOULHUX7YZLKU17) -- unlike `commitledger.store`'s multi-application
...
(def ^:private demo-full-text
  "Terms and Conditions\nThese Terms and Conditions govern access to and use of the Antero Resources Corporation website. By using this site you agree to these Terms, which may be updated without notice. This agreement is governed by the laws of the State of Delaware.")

(defn demo-baseline []
  {:full-text    demo-full-text
   :source-url   "https://www.anteroresources.com/terms-and-conditions"
   :retrieved-at "2026-07-10T05:27:00Z"
