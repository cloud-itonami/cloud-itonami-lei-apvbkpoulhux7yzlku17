...
Antero Resources Corporation, per ADR-2607110300 -- a read-only reference
...
- **Company**: Antero Resources Corporation, LEI APVBKPOULHUX7YZLKU17,
...
- **Baseline provenance** (real, from this repo's own `80-data/public/
  ...
  `https://www.anteroresources.com/terms-and-conditions`, retrieved-at
  `2026-07-10T05:27:00Z`, doc-type `:terms-of-service`.
